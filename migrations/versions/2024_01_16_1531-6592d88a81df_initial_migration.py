...
def upgrade() -> None:
    ...
    op.execute("CREATE SCHEMA IF NOT EXISTS codes;")
    op.execute("CREATE SCHEMA IF NOT EXISTS hame;")
...
def downgrade() -> None:
    ...
    op.execute("DROP SCHEMA IF EXISTS codes;")
    op.execute("DROP SCHEMA IF EXISTS hame;")
    # ### end Alembic commands ###
